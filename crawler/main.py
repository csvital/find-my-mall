...
#mm-0 > div.container-fluid.center > div.avmList > div > div > div.col-lg-9.col-xs-12 > div.avmListIcerik.box-shadow > ul > li:nth-child(1) > div > div > div.col-lg-9.col-md-9.col-sm-9.col-xs-12.info > div.isim > a